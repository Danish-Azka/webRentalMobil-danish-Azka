  ...
  return (
    <>
       <div className='flex py-1 items-center justify-between  mx-auto '>
          <div className={`absolute h-fit left-[171px] flex items-center  transition-all duration- ease-in ${open ? "top-[45px] opacity-100" : "top-[-200px] opacity-100"}`}>
            <ul className='flex rounded-s-xl bg-slate-300 py-1 opacity-100 flex-col text-sm text-white font-semibold cursor-pointer'>
              <p className='text-start px-1'>Profile</p>
