...
const [data, setData] = useState()
  ...
  <div className="bg-slate-100 w-[400px] rounded-lg shadow-lg px-3 flex flex-col justify-center relative">
    ...
    <div className='bg-slate-300 rounded-full h-24 w-24 mx-auto absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2'>
      d
    </div>
    ...
    <div className="flex justify-end gap-2">
      {/* Buttons or additional elements */}
    </div>
  </div>
</div>
  );
