  ...
  return (
    <>
      <div className='h-full w-full'>
        <div className='w-full h-[30%] bg-[#87b81b] py-4 px-4'>
          <div className='flex justify-between'>
            <div>
            <span className="relative flex h-3 w-3">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-greeen-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-3 w-3 bg-greeen-500"></span>
            </span>
            </div>
            <div>
