...
const [data, setData] = useState()
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      ...
      <div className="bg-white rounded-lg py-6 justify-end items flex shadow-lg">
          <button
        ...
        <div className='bg-slate-300 rounded-full h-20 w-20 mx-auto right-[200px] absolute'>d</div>
