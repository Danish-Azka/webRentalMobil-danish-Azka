  ...
  return (
    <>
       <div className='flex py-1 items-center justify-between  mx-auto '>
              {isFormVisible && <Profile onClose={openProfile} />}
          <div className={`absolute h-fit left-[171px] flex items-center bg-red-500  transition-all duration-500 ease-in ${open ? "top-[45px] opacity-100" : "top-[-200px] opacity-100"}`}>
