...
const ModalFormTransaksi = ({ onClose }) => {
  ...
  var tanggalPinjam = new moment(formData.tanggalPeminjaman); 
  var tanggalKembali = new moment(formData.batasPeminjaman); 
  var selisih = tanggalKembali.diff(tanggalPinjam, 'days')
  console.log(selisih)
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              type="text"
              name="durasiSewa"
              value={isNaN(selisih) || selisih === null ? "" : selisih}
              // onChange={(e) => handleChange(e)}
              className="border border-gray-300 p-2 w-full"
              required
            />
